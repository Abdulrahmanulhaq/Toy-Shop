          ...
          <div className="image">
           ...
           <div className="image">
            ...
            <div className="image">
                ...
                <h3>$106</h3>
                <button onClick={() =>props.addBasket('minionlego')} className="addToCart cart11" >Add to Cart</button>
            </div>
            <div className="image">
                <img src={nerf3} alt="Nerf N-Strike Elite Infinus" title='Nerf N-Strike Elite Infinus'/>
                <h3>Nerf N-Strike Elite Infinus</h3>
                <h3>$650</h3>
                <button onClick={() =>props.addBasket('nerf3')} className="addToCart cart12" >Add to Cart</button>
            </div>
            <div className="image">
                <img src={nerf4} alt="Nerf Rival Nemesis MXVII-10K" title='Nerf Rival Nemesis MXVII-10K'/>
                <h3>Nerf Rival Nemesis MXVII-10K</h3>
                <h3>$850</h3>
                <button onClick={() =>props.addBasket('nerf4')} className="addToCart cart13" >Add to Cart</button>
            </div>
            <div className="image">
                <img src={evilminion} alt="Evil Minion" title='evil minion'/>
                <h3>Evil Minion</h3>
                <h3>$39,08</h3>
                <button onClick={() =>props.addBasket('evilminion')} className="addToCart cart14" >Add to Cart</button>
            </div>
            <div className="image">
                <img src={babygroot} alt="Baby Groot" title='baby groot'/>
                <h3>Baby Groot</h3>
                <h3>$42,78</h3>
                <button onClick={() =>props.addBasket('babygroot')} className="addToCart cart15" >Add to Cart</button>
            </div>
            <div className="image">
